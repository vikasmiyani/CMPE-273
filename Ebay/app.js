...
app.get('/fetchDetail',detail.fetchDetail);
...
app.delete('/deleteShoppingCartItem',shoppingCart.deleteShoppingCartItem);


// auction job which run at every 10 min
setInterval(auction.checkAuction,10*60*1000);
