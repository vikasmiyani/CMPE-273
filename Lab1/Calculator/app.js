...
app.post('/addition',routes.addition);
app.post('/subtraction',routes.subtraction);
app.post('/multiplication',routes.multiplication);
app.post('/division',routes.division);
